...
The dream's UI design has been inspired by Flipboard's day dream, which shows snippets of its feed with a Ken Burns animation effect. At the moment, the feed is shown and animated, but it might be nice to make this day dream interactive. For instance to 
...
* The KenBurns effect often zooms in too much making the background display very ugly. This can be fixed by replacing the RandomTransitionGenerator with a custom generator whose transitions are a little more subtle.
