...
import nl.jozuasijsling.blendledream.BuildConfig;

/**
 */
public class DreamFeedContentUris {

    public static final String AUTHORITY = BuildConfig.APPLICATION_ID;

    public static final Uri ISSUES_URI = Uri.parse("content://" + AUTHORITY + "/issues");
    public static final Uri ISSUES_REPLACE_URI = Uri.withAppendedPath(ISSUES_URI, "replace");
