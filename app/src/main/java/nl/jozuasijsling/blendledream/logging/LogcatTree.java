...
package nl.jozuasijsling.blendledream.logging;
...
/**
 * This tree submits log events to logcat.
 */
public class LogcatTree extends Timber.Tree {
    ...
    /**
     * @param logLevel Log events with priority below this value are ignored.
     */
