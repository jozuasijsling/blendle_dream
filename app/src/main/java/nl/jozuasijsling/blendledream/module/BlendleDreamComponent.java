...
import nl.jozuasijsling.blendledream.BlendleDreamApplication;
import nl.jozuasijsling.blendledream.DownloadDreamFeedService;

/**
 * Injects the basic modules for this app.
 */
@Component(modules = { NetworkModule.class, DataModule.class } )
@Singleton
public interface BlendleDreamComponent {

    void inject(DownloadDreamFeedService service);
    void inject(BlendleDreamApplication application);
