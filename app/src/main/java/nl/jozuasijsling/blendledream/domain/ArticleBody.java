...
/**
 * An ordered list of {@linkplain ContentElement content elements}. The content elements
 * together make up the body of a single Blendle article.
 */
public class ArticleBody {

    @NonNull private List<ContentElement> mElements;

    public ArticleBody(@NonNull List<ContentElement> elements) {
